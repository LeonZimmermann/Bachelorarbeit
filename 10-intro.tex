...
\begin{itemize}
   \item \textbf{Definition von Anwendungsfällen:}
         ...
         Diese Suchanfragen können gegen an zwei verschiedene Suchfunktionen übergeben werden.
         Anschließend können die gefundenen Ergebnisse verglichen werden.
         Die genaue Vorgehensweise für diesen Vergleich wird in den Teilschritten "Herausarbeitung von Evaluationsmethoden und -Kriterien" und "Durchführung der Studie" erklärt.
   ...
   \item \textbf{Herausarbeitung von Evaluationsmethoden und -Kriterien:}
         ...
         Das hier erläuterterte Wissen wird für die Durchführung der Studie benötigt.
...
In dem Paper "TaskNav: Task-based Navigation of Software Documentation" von Treude et. al. geht es um die Entwicklung einer Oberfläche, welche die Suche von \textit{Tasks} ermöglicht.
...
So wie die vorherigen Paper soll auch dieses Paper eine Brücke zwischen Dokumentation und Code schaffen.