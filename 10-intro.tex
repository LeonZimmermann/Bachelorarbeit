...
Nochmals andere Arbeiten untersuchen Downstream Tasks von Suchfunktionen, also Algorithmen, welche das Ergebnis einer Suche verarbeiten, um die gleiche oder eine andere Anforderung an ein System umzusetzen.\\
...
Das Paper \textit{Estimating the recall performance of Web search engines} von Clarke und Willet misst die Qualität von Suchfunktionen des World Wide Webs anhand dessen Recalls.
Um dies zu ermöglichen wird ein Datensatz generiert, welche Sucheingaben beinhaltet, sowie alle relevanten Dokumente für eine Sucheingabe.\cite{Clarke_Willett_1997}
...
Hier wird ebenfalls auf die Problematik der Messung von Recall eingegangen.
...
Darüber hinaus schließst das Paper auf essenzielle Techniken für Open-Domain Question Answering.
