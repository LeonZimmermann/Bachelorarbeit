...
Diese Information ist oftmals die Spezifikationen oder Dokumentationen eines Teiles der Software, mit welcher der Softwareentwickler gerade arbeitet.
...
Large Language Models, wie GPT, sollen dabei nicht beachtet werden, weil sie nicht in den Umfang der Arbeit passen.

\section{Vorgehensweise}

Die Gründe, warum die gewünschte Information nicht gefunden werden konnte, sind vielzählig.
Das kann daran liegen, dass die gefundenen Ergebnisse zu spezifisch sind, z.B. wenn eine allgemeine Definition von Domänenobjekten gesucht wird, aber eine Spezifikation eines Anwendungsfalls gefunden wird, in welchem das Domänenobjekt lediglich erwähnt wird.
...
Zur Lösung dieses Problems werden folgende Teilziele definiert:
\begin{itemize}
   \item \textbf{Definition von Anwendungsfällen:}
         Es werden zunächst Anwendungsfälle definiert.
         Damit wird das Problem der Performance von Suchen heruntergebrochen in Teilprobleme.
         Das soll später dabei helfen mehrere Suchfunktionen miteinander vergleichen zu können.
         Außerdem bietet dies bereits Aufschluss über die möglichen Verbesserungen, welche gemacht werden können.
   \item \textbf{Herausarbeitung von Evaluationsmethoden und -Kriterien:}
         ...
         Die hier erläutertern Informationen sind notwendig für die Durchführung einer Studie.
   \item \textbf{Erklärung des theretischen Hintergrunds:}
         Es wird die Theorie für die Implementierung einer Suchfunktion erläutert.
         Die Theorie erklärt, welche Suchfunktionen es gibt.
         Außerdem erklärt sie Verfahren zur Indizierung von Dokumenten.
   ...
   \item \textbf{Implementierung:}
         ...
         Es wird die Weaviate Vektordatenbank verwendet, um Dokumente zu indizieren.
