...
\newcommand{\documentHeading}{Natural Language Processing zur Verbesserung von Suchfunktionen in der Software-Entwicklung}
...
\input{10-intro}
\input{20-auswahl-von-use-cases}
\input{30-evaluationsmethoden-und-kriterien}
\input{40-such-und-nlp-algorithmen}
\input{50-vergleich-der-suchfunktionen}
\input{60-erlaeuterung-des-ergebnisses}
\input{70-implementierung}
