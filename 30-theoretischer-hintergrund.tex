...
Wenn der Nutzer nicht genau weiß, wie eine Seite heißt nach der er sucht, dann kann er sie bei einer semantischen Suche umschreiben und trotzdem ein sinnvolles Ergebnis bekommen.
...
So kann die semantische Suche mit weiteren Daten angereichert werden und damit verbessert werden.
Dies ist zwar auch bei der Verwendung eines Volltext-Indizes möglich, nicht aber auf die gleiche Weise, wie bei Vector Space Models.
Denn Vector Space Models sind Multimodal.
...
TODO: Möglichkeit zur Verwendung von LLMs: Question Answering Modelle oder Chatbots.
